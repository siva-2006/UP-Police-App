          ...
          body: SafeArea(
            child: Column(
              children: [
                ...
                _buildMenuButton(isHindi ? 'ड्राइवर का विवरण' : 'Driver Details', Icons.person_search, () => Navigator.push(context, MaterialPageRoute(builder: (context) => const DriverDetailsScreen()))),
